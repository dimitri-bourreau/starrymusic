...
export function AboutSection(props: React.ComponentPropsWithoutRef<'section'>) {
  ...
  return (
    <section {...props}>
      <h2 className="flex items-center font-mono text-sm font-medium leading-7 text-slate-900 dark:text-slate-400">
        <TinyWaveFormIcon
      ...
      <p
        className={clsx(
          'mt-2 text-base leading-7 text-slate-700 dark:text-zinc-300',
